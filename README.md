...
> which supports both **Codex CLI** , **Codex App** and **Claude Code** out of the box.
...
in `~/.claude/settings.json`. For Codex CLI or Codex App, just run `start` once — the bridge
